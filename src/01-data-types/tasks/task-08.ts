...
interface AirTemperature {time: string, temperature: number}

const greenhouseReadings: AirTemperature[] = [
...
console.table(greenhouseReadings);

// Versi console.log

console.log(`Deskripsi Suhu: `);
